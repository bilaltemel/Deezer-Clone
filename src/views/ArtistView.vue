...
<template>
        ...
        <div class="flex gap-4 items-center justify-start bottom-0 mb-1.5">
          ...
          >
            <div v-if="!isPlaying" class="flex items-center">
              ...
              <div class="text-white font-bold text-xs pr-1">OYNAT</div>
            </div>

            <div v-else class="flex items-center">
              <Pause fillColor="#FFFFFF" :size="20" />
              <div class="text-white font-bold text-xs pr-1">DURDUR</div>
            </div>
          </button>
          <button
            type="button"
            class="rounded-full p-2 border border-[#42525D] hover:bg-[#2b2b30]"
          >
  ...
  <div id="SongsSection" class="max-w-[1500px] mx-auto">
    <div class="pl-8">
      <div class="text-white text-3xl font-semibold mb-7">En İyi Parçalar</div>

      <div
        class="flex items-center border border-[#525254] bg-[#23232D] rouded-sm text-[#c9c9c9] w-[300px]"
      >
        ...
        <input
          ...
          placeholder="Parçalar İçinde Arama Yapın"
        />
      </div>
    </div>
    ...
    >
      <div class="text-xs font-light text-[#aeaeae]">OYNAT</div>
      <ClockTimeFiveOutline fillColor="#aeaeae" :size="20" />
    </div>

    <ul
      class="w-full mx-8 pr-16 min-w-[650px] text-white"
