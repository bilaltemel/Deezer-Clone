  ...
  <div class="max-w-[1500px] mx-auto">
    <div class="px-8 mt-8 min-w-[800px] w-full">
      <div class="text-white text-xl font-semibold inline-block">
        İlham alınan karışımlar...
        <div class="text-sm font-light text-[#A2A2AD]">
          Yeni favori şarkılarınızı keşfedin
        </div>
      </div>
      <div class="py-3"></div>
    ...
    <div class="px-8 mt-8 min-w-[800px]">
      ...
      <p class="text-center pb-6 text-[#D1D1D6] text-sm">
        Dinlediğiniz sanatçılara göre önerilerde bulunulmaktadır.
      </p>
      ...
      <div class="flex justify-center gap-7 w-full">
        <div class="flex items-center justify-center relative">
          ...
          <img
            width="160"
            class="rounded-full z-20 cursor-pointer"
            src="https://picsum.photos/id/154/300/300"
          />
          <img
            width="115"
            class="absolute -right-[80px] rounded-full z-10 cursor-pointer"
    ...
    <div class="mt-8 min-w-[800px]">
      <CustomCarousel
        category="Yeni Yayınlanan Şarkılar"
        :data="[
          {
            url: 'https://picsum.photos/id/89/300/300',
            song: 'Foregone',
          ...
          },
          {
            ...
            song: 'The Future Is Your Past',
            by: 'In The Brian Jonestown Massacre',
            releasedOn: '10/23/2023',
          },
          {
            url: 'https://picsum.photos/id/211/300/300',
            song: 'The Land, The Water, The Sky',
            by: 'Black Belt Eagle Scout',
            releasedOn: '11/23/2023',
          },
          {
            url: 'https://picsum.photos/id/223/300/300',
            song: 'The Day My Father Died',
            by: 'SYML',
            releasedOn: '12/23/2023',
          },
          {
            url: 'https://picsum.photos/id/225/300/300',
            song: 'Complete Mountain Almanac',
            by: 'Complete Mountain Almanac',
            releasedOn: '13/23/2023',
          },
          {
            url: 'https://picsum.photos/id/239/300/300',
            song: 'Music From Montana Story',
        ...
        :data="[
          {
            ...
            song: 'Foregone',
            by: 'In Flames',
            releasedOn: '10/05/2023',
          },
          {
            url: 'https://picsum.photos/id/144/300/300',
            song: 'Dark Waters',
            by: 'Delain',
            releasedOn: '19/05/2023',
          },
          {
            url: 'https://picsum.photos/id/146/300/300',
            song: 'Heritage',
            by: 'Distant',
            releasedOn: '24/04/2023',
          },
          {
            url: 'https://picsum.photos/id/78/300/300',
            song: 'Meanwhile',
            by: 'Klone',
            releasedOn: '21/12/2023',
          },
          {
            url: 'https://picsum.photos/id/151/300/300',
            song: 'Truth Decay',
            by: 'You Me At the Six',
            releasedOn: '02/02/2023',
          },
          {
            url: 'https://picsum.photos/id/155/300/300',
            song: 'This is Why',
          ...
          },
          {
            ...
            song: 'This is Why',
            by: 'Uzaylılar Tarafından',
            releasedOn: '02/02/2023',
          },
          {
            url: 'https://picsum.photos/id/194/300/300',
            song: 'Ateş Su Toprak Tahta',
            by: 'Uzaylılar Tarafından',
            releasedOn: '22/09/2023',
          },
          {
