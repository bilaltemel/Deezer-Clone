...
<template>
  ...
  >
    <div class="flex items-center w-full">
      ...
      <input
        class="p-1 bg-transparent outline-none foont-[300] placeholder-[#BEBEC7] w-full max-w-xl"
        placeholder="Search"
        type="text"
      />
    </div>
  ...
  >
    ...
    <SideMenuItem iconString="music" :iconSize="20" pageUrl="/" name="Müzik" />
    <SideMenuItem
      iconString="podcast"
      :iconSize="20"
      pageUrl="/podcasts"
    ...
    <div class="text-[#A2A2AD] font-light text-[12px] pl-[62px] mt-[25px]">
      ...
      <div class="py-[9px] hover: text-[#EF5465] cursor-pointer">Albümler</div>
      <div class="py-[9px] hover: text-[#EF5465] cursor-pointer">
        Sanatçılar
      </div>
      <div class="py-[9px] hover: text-[#EF5465] cursor-pointer">
