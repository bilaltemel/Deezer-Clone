...
import HeartOutline from "vue-material-design-icons/HeartBoxOutline.vue";
    ...
    <div class="pl-8">
        <RouterLink to="/artist" class="cursor-pointer">
            ...
            <div class="text-white text-left mt-2">
                ...
                <div class="text-[11px] pt-0.5 text-[#858590]">{{ slide.releasedOn }} tarihinde yayımlandı</div>
            </div>
        </RouterLink>
    </div>
</template>