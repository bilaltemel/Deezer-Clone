  ...
  <div>
    <RouterLink :to="to" class="relative">
      ...
      >
        ...
        />
        <img
          class="absolute contarast-[0.55] right-0 top-0 w-1/2"
          :src="images.one"
        />
        <img
          class="absolute contarast-[0.55] left-0 top-0 w-1/2"
          :src="images.two"
        />
        <img
          class="absolute contarast-[0.55] right-0 bottom-0 w-1/2"
          :src="images.three"
        />
        <img
          class="absolute contarast-[0.55] left-0 bottom-0 w-1/2"
          :src="images.four"
        />
